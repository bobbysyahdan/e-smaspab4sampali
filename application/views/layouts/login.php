...
<body class="vertical-layout vertical-menu-modern dark-layout blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page" data-layout="dark-layout">
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <!-- <h4 class="card-title mb-1">SMAS PAB 4 Sampali! 👋</h4> -->
                                ...
                                <?php endif; ?>
                                <form class="auth-login-form mt-2" action="<?= base_url('site/login') ?>" method="POST">
                                    <div class="form-group">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="email" name="email" placeholder="john@example.com" aria-describedby="email" tabindex="1" autofocus value="<?= set_value('email') ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input type="password" class="form-control form-control-merge" id="login-password" name="password" tabindex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
    ...
    <script src="<?= base_url('assets_template/app-assets/vendors/js/forms/validation/jquery.validate.min.js') ?>"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?= base_url('assets_template/app-assets/js/scripts/pages/page-auth-login.js') ?>"></script>
    <!-- END: Page JS-->
