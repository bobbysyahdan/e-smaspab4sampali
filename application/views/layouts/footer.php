<div class="sidenav-overlay"></div>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; <?= date('Y'); ?><a class="ml-25" href="<?= base_url('/') ?>" target="_blank">SMAS PAB 4 SAMPALI</a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span></p>
    </footer>
