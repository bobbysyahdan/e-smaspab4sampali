...
<head>
    ...
    <title><?= $title ?></title>
    <link rel="apple-touch-icon" href="<?= base_url('/upload/logo/logo.jpeg') ?>') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('/upload/logo/logo.jpeg') ?>">
                ...
                <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?= base_url('/assets_template/app-assets/images/pages/eCommerce/1.png') ?>" alt="donuts" width="62">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?= base_url('/assets_template/app-assets/images/pages/eCommerce/7.png') ?>" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?= base_url('/assets_template/app-assets/images/pages/eCommerce/2.png') ?>" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?= base_url('/assets_template/app-assets/images/pages/eCommerce/3.png') ?>" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?= base_url('/assets_template/app-assets/images/pages/eCommerce/5.png') ?>" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                ...
                <li class="nav-item dropdown dropdown-notification mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="bell"></i><span class="badge badge-pill badge-danger badge-up">5</span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                ...
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img src="<?= base_url('/assets_template/app-assets/images/portrait/small/avatar-s-3.jpg') ?>" alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="media-body">
