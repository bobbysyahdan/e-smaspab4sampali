                                ...
                                <form action="<?= base_url('siswa/update/'.$siswa['id']) ?>" method="POST">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kelas" id="kelas" class="form-control">
                                                ...
                                                <?php if(count($kelas) > 0): foreach($kelas as $value): ?>
                                                    <option value="<?= $value['id'] ?>" <?= $value['id'] == $siswa['kelas'] ? 'selected' : '' ?>><?= $value['nama_kelas'].' - '.$value['tahun_ajaran'] ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" value="<?= $siswa['nama_lengkap'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" value="<?= $siswa['tempat_lahir'] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="demo-inline-spacing">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio1" name="jenis_kelamin" class="custom-control-input" value="1" <?= $siswa['jenis_kelamin'] == 1 ? 'checked' : '' ?>>
                                                    <label class="custom-control-label" for="customRadio1">Laki-laki</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="customRadio2" name="jenis_kelamin" class="custom-control-input" value="2" <?= $siswa['jenis_kelamin'] == 2 ? 'checked' : '' ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_orangtua" class="form-control" placeholder="Nama Orangtua" value="<?= $siswa['nama_orangtua'] ?>">
                                            <small class="text-danger"><?= form_error('nama_orangtua') ?></small>
                                        </div>
                                        <div class="form-group">
                                            <strong>Nomor Handphone:</strong>
                                            <input type="text" name="no_handphone" class="form-control" placeholder="no_handphone" value="<?= $siswa['no_handphone'] ?>">
