                                    ...
                                    <table class="datatables-ajax table" id="table_id"> 
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('/bookIdentity/bookContentImages/'.$book_identity['id']) ?>" class="btn btn-primary">Book Content Images</a></td>
                                                <!-- <td><s?= $book_identity['amount_subscribe'] ?></td> -->
                                                <td>
