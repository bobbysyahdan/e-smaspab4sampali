                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body mt-2">
                                <form action="<?= base_url('refSubscribePackage/create') ?>" method="POST">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Package Name:</strong>
                                                <input type="text" name="package" class="form-control" placeholder="Package Name" value="<?= set_value('package') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_package_edition" id="id_package_edition" class="form-control">
                                                    ...
                                                    <?php if(count($package_editions) > 0): foreach($package_editions as $package_edition): ?>
                                                        <option value="<?= $package_edition['id'] ?>"><?= $package_edition['package_edition'] ?></option>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="days" class="form-control" placeholder="Days" value="<?= set_value('days') ?>">
