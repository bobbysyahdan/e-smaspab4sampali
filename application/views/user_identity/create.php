                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body mt-2">
                                <form action="<?= base_url('userIdentity/create/'.$id_user) ?>" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Fullname:</strong>
                                                <input type="text" name="fullname" class="form-control" placeholder="Fullname" value="<?= set_value('fullname') ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_of_birth" class="form-control" placeholder="Date of Birth" value="<?= set_value('date_of_birth') ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="demo-inline-spacing">
                                                    ...
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customRadio<?=$key?>" name="gender" class="custom-control-input" value="<?= $data['id'] ?>">
