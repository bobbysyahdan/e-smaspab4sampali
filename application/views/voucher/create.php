                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body mt-2">
                                <form action="<?= base_url('voucher/create') ?>" method="POST">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Voucher Code:</strong>
                                                <input type="text" name="voucher_code" class="form-control" placeholder="Voucher Code" value="<?= set_value('voucher_code') ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="percentage_discount" class="form-control" placeholder="Percentage Discount" value="<?= set_value('percentage_discount') ?>">
